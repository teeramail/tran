<template>
  ...
  const sliderImages = [
    { src: 'https://koh-samui.com/travelmain/grandsea/img/grandseatour%20carousel-1.jpg', alt: 'Slider Image 1' },
  ...
  const products = [
    {
      ...
      price: 100,
      imageSrc: 'https://koh-samui.com/travelmain/grandsea/img/grandseatour%20package-1.jpg',
    },
    {
      id: 2,
      name: 'Product 1',
      description: 'Product 1 description goes here...',
      price: 100,
      imageSrc: 'https://koh-samui.com/travelmain/grandsea/img/grandseatour%20package-2.jpg',
    },
    {
      id: 3,
      name: 'Product 1',
